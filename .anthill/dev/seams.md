...
>
> **forager (the owner) — NOT YET RECORDED.** His ask for this ratify is comms #50; **his own verdict on (a)–(d) is still wire-only or unstated.** Until it is here, treat the contract as ratified by the consumer and unratified by the owner.
>
